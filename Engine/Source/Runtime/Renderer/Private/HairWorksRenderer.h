...
namespace HairWorksRenderer
{
	...
	BEGIN_UNIFORM_BUFFER_STRUCT(FHairInstanceDataShaderUniform, )	// We would use array of structure instead of array of raw float in future.
		UNIFORM_MEMBER_ARRAY(FVector4, Spec0_SpecPower0_Spec1_SpecPower1, [HairInstanceMaterialArraySize])
		UNIFORM_MEMBER_ARRAY(FVector4, Spec1Offset_DiffuseBlend_ReceiveShadows_ShadowSigma, [HairInstanceMaterialArraySize])
		UNIFORM_MEMBER_ARRAY(FVector4, GlintStrength_LightingChannelMask, [HairInstanceMaterialArraySize])
