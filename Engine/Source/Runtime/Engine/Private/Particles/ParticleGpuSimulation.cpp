...
UNIFORM_MEMBER(int32, Count)
UNIFORM_MEMBER_ARRAY(FIntVector, BlockDim, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(FIntVector, BlockDimBits, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(FVector, BlockDimInv, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(FIntVector, LinearBlockDim, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(FIntVector, LinearBlockOffset, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(FVector, DimInv, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(FVector, VDim, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(FVector, VDimInv, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(FIntVector, PoolGridDim, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(FIntVector, GridDim, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(int32, IsVTR, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(FMatrix, WorldToVolume, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(float, VelocityScale, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(float, GridToParticleAccelRate, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(float, GridToParticleDecelRate, [MAX_NVFLOW_GRIDS])
UNIFORM_MEMBER_ARRAY(float, GridToParticleThreshold, [MAX_NVFLOW_GRIDS])
